...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteApp = __webpack_require__(166);
	...
	window.main = function () {
	    _reactDom2.default.render(_react2.default.createElement(_NoteApp2.default, null), document.getElementById('panel-body'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteListBox = __webpack_require__(167);

	var _NoteListBox2 = _interopRequireDefault(_NoteListBox);

	var _NoteCreationBox = __webpack_require__(185);
	...
	var NoteApp = function (_React$Component) {
		...
		function NoteApp() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NoteApp).call(this));
		...
		_createClass(NoteApp, [{
			...
			value: function onAdd() {
				_reactDom2.default.findDOMNode(this.refs.noteBox.refs.textBox.refs.textArea).focus();
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(_NoteCreationBox2.default, { id: this.state.currentlyEdited, ref: 'noteBox' }),
						_react2.default.createElement(_NoteListBox2.default, { onEdit: this.onEdit.bind(this), onAdd: this.onAdd.bind(this) })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteList = __webpack_require__(168);

	var _NoteList2 = _interopRequireDefault(_NoteList);

	var _NoteStores = __webpack_require__(170);
	...
	var NoteListBox = function (_React$Component) {
		_inherits(NoteListBox, _React$Component);

		function NoteListBox() {
			_classCallCheck(this, NoteListBox);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NoteListBox).call(this));

			_this.state = {
				notes: _NoteStores2.default.getNotes()
			};
			return _this;
		}

		_createClass(NoteListBox, [{
			key: 'onChange',
			value: function onChange(notes) {
				this.setState({
					notes: notes
				});
			}
			...
			value: function componentDidMount() {
				this.unsubscribe = _NoteStores2.default.listen(this.onChange.bind(this));
			}
		}, {
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-12' },
					_react2.default.createElement(_NoteList2.default, { ref: 'noteList', notes: this.state.notes, onEdit: this.props.onEdit.bind(this) }),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ onClick: this.onAdd.bind(this), className: 'btn btn-info btn-lg' },
							'Add New'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Note = __webpack_require__(169);
		...
		_createClass(NoteList, [{
			...
			value: function render() {
				...
				var noteNodes = notes.map(function (note) {
					return _react2.default.createElement(_Note2.default, { key: note._id, active: that.state.activeNoteId === note._id, note: note, onEdit: that.props.onEdit.bind(this), onSelect: that.setActiveNote.bind(this) });
				});
				return _react2.default.createElement(
					'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Note = function (_React$Component) {
		...
		_createClass(Note, [{
			key: 'handleEdit',
			value: function handleEdit(id, e) {
				e.preventDefault();
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'a',
					{ href: '#', className: 'list-group-item ' + className, onClick: this.handleEdit.bind(this) },
					title
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteActions = __webpack_require__(184);
	...
	var _notes = [];
	var NoteStores = _reflux2.default.createStore({
		init: function init() {
			this.listenTo(_NoteActions2.default.createNote, this.onCreate);
			this.listenTo(_NoteActions2.default.editNote, this.onEdit);
		},
		onCreate: function onCreate(note) {
			_notes.push(note);
			this.trigger(_notes);
		},
		onEdit: function onEdit(note) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListenerMethods = __webpack_require__(172);

	exports.PublisherMethods = __webpack_require__(178);

	exports.createAction = __webpack_require__(179);

	exports.createStore = __webpack_require__(176);

	exports.connect = __webpack_require__(180);

	exports.ListenerMixin = __webpack_require__(181);

	exports.listenTo = __webpack_require__(182);

	exports.listenToMany = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	     ...
	     */
	    fetchDefaultData: function fetchDefaultData(listenable, defaultCallback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(174);
	...
	exports.isArguments = function (value) {
	    return value && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) == 'object' && typeof value.length == 'number' && (toString.call(value) === '[object Arguments]' || hasOwnProperty.call(value, 'callee' && !propertyIsEnumerable.call(value, 'callee'))) || false;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(173),
	    Reflux = __webpack_require__(171),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(173),
	    ListenerMethods = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteActions = _reflux2.default.createActions(["createNote", "editNote"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextArea = __webpack_require__(186);
	...
	var NoteCreationBox = function (_React$Component) {
		_inherits(NoteCreationBox, _React$Component);

		function NoteCreationBox() {
			_classCallCheck(this, NoteCreationBox);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(NoteCreationBox).apply(this, arguments));
		}
		...
		_createClass(NoteCreationBox, [{
			...
			value: function handleSave(noteText, id) {
				if (id) {
					...
					_NoteActions2.default.createNote({ _id: Date.now(), text: noteText });
				}
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-12' },
					_react2.default.createElement(_TextArea2.default, { onSave: this.handleSave.bind(this), id: this.props.id, ref: 'textBox', noteText: note ? note.text : '' })
				);
			}
		}]);
	...
	var TextArea = function (_React$Component) {
		...
		_createClass(TextArea, [{
			...
			value: function handleSave() {
				...
				if (!id) {
					_reactDom2.default.findDOMNode(this.refs.textArea).value = '';
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('textarea', { className: 'form-control', ref: 'textArea', cols: '100', rows: '10', value: this.state.noteText, onChange: this.handleChange.bind(this) }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { type: 'button', className: 'btn btn-success btn-lg', value: 'Save', onClick: this.handleSave.bind(this) })
				);
			}
		}]);
